...
class V1_20CompatImplementationTest {
    @Test
    void identifiesSupportedServerAndCapabilities() {
        V1_20CompatImplementation implementation = new V1_20CompatImplementation();

        assertEquals("compat-v1_20", implementation.id());
        assertEquals(ServerVersion.of(1, 20, 4), implementation.version());
